...
public class NearbyActivity extends AppCompatActivity {
    ...
    ArrayList<NearbyModel> nearbylist;
    String json_string;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.nearbyre);
        ...
        try{
            ...
            while(count<jsonArray.length())
            {
                ...
                nearbylist.add(new NearbyModel(R.drawable.evdp,name,venue,date));
                count++;
            }
        ...
        NearbyAdapter adapter = new NearbyAdapter(this,nearbylist);
